/**
 * ============================================================================
 * ACCOUNT PAGE - PLAYER ACCOUNT MANAGEMENT
 * ============================================================================
 *
 * Purpose: Manage player account balance (deposit and withdraw)
 * Clear, international naming for any cashier to understand
 *
 * Features:
 * - Deposit: Add funds to player account (scan QR → enter amount → confirm)
 * - Withdraw: Cash out from player account (scan QR → enter amount → confirm)
 *
...
export function AccountPage() {
  ...
  const [mode, setMode] = useState<AccountMode>('menu')
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Scan player QR code to deposit or withdraw
          </p>
          ...
          <div style={{
            ...
            <button
              ...
              onMouseEnter={() => setHoveredOption('deposit')}
              ...
              style={{
                ...
                borderRadius: '20px',
                cursor: 'pointer',
                boxShadow: hoveredOption === 'deposit'
                  ? '0 12px 32px rgba(16, 185, 129, 0.25)'
                  : '0 4px 16px rgba(0,0,0,0.06)',
                transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                transform: hoveredOption === 'deposit' ? 'translateY(-4px)' : 'translateY(0)',
              }}
            >
              <div style={{
                width: '56px',
                ...
                <ArrowDownToLine size={28} color="white" />
              </div>
            ...
            <button
              ...
              onMouseEnter={() => setHoveredOption('withdraw')}
              onMouseLeave={() => setHoveredOption(null)}
              style={{
                display: 'flex',
                alignItems: 'center',
                ...
                borderRadius: '20px',
                cursor: 'pointer',
                boxShadow: hoveredOption === 'withdraw'
                  ? '0 12px 32px rgba(239, 68, 68, 0.25)'
                  : '0 4px 16px rgba(0,0,0,0.06)',
                transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                transform: hoveredOption === 'withdraw' ? 'translateY(-4px)' : 'translateY(0)',
              }}
            >
              <div style={{
                width: '56px',
                ...
                <ArrowUpFromLine size={28} color="white" />
              </div>
              <div style={{ flex: 1, textAlign: 'left' }}>
                <span style={{
                  fontSize: '18px',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {isDeposit ? <ArrowDownToLine size={24} color="white" /> : <ArrowUpFromLine size={24} color="white" />}
          <h1 style={{
            color: 'white',
            fontSize: '18px',
            fontWeight: 700,
        ...
        <div style={{
          ...
          {playerAccount && (
            <>
              ...
              >
                {isDeposit ? <ArrowDownToLine size={22} /> : <ArrowUpFromLine size={22} />}
